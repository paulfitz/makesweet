...
#define gdFree free
#define gdCalloc calloc
#define gdRealloc realloc
#define overflow2 pf_overflow2
...
/*
 * Module initialization routine for 2-pass color quantization.
 * Modified to be usable for multiple images
 */


void *pf_gdQuantizeInit (gdImagePtr oim, gdImagePtr nim) {
  //printf("QuantizeInit\n");
  my_cquantize_ptr cquantize = NULL;
  int i;
...
void pf_gdQuantizeApply (void *v, gdImagePtr oim, int dither, gdImagePtr nim) {
  my_cquantize_ptr cquantize = (my_cquantize_ptr)v;
  //printf("QuantizeApply\n");
